...
handleMessage('ELECTRON_BROWSER_REQUIRE', function (event, contextId, module) {
  return valueToMeta(event.sender, contextId, process.mainModule.require(module))
})

handleMessage('ELECTRON_BROWSER_GET_BUILTIN', function (event, contextId, module) {
  return valueToMeta(event.sender, contextId, electron[module])
})

handleMessage('ELECTRON_BROWSER_GLOBAL', function (event, contextId, name) {
  return valueToMeta(event.sender, contextId, global[name])
})

handleMessage('ELECTRON_BROWSER_CURRENT_WINDOW', function (event, contextId) {
  return valueToMeta(event.sender, contextId, event.sender.getOwnerBrowserWindow())
})

handleMessage('ELECTRON_BROWSER_CURRENT_WEB_CONTENTS', function (event, contextId) {
  return valueToMeta(event.sender, contextId, event.sender)
})

handleMessage('ELECTRON_BROWSER_CONSTRUCTOR', function (event, contextId, id, args) {
...
handleMessage('ELECTRON_BROWSER_FUNCTION_CALL', function (event, contextId, id, args) {
  args = unwrapArgs(event.sender, contextId, args)
...
handleMessage('ELECTRON_BROWSER_MEMBER_CONSTRUCTOR', function (event, contextId, id, method, args) {
  args = unwrapArgs(event.sender, contextId, args)
...
handleMessage('ELECTRON_BROWSER_MEMBER_CALL', function (event, contextId, id, method, args) {
  args = unwrapArgs(event.sender, contextId, args)
...
handleMessage('ELECTRON_BROWSER_MEMBER_SET', function (event, contextId, id, name, args) {
  args = unwrapArgs(event.sender, contextId, args)
  let obj = objectsRegistry.get(id)
...
handleMessage('ELECTRON_BROWSER_MEMBER_GET', function (event, contextId, id, name) {
  let obj = objectsRegistry.get(id)
...
handleMessage('ELECTRON_BROWSER_DEREFERENCE', function (event, contextId, id) {
  objectsRegistry.remove(event.sender, contextId, id)
})

handleMessage('ELECTRON_BROWSER_CONTEXT_RELEASE', (event, contextId) => {
  objectsRegistry.clear(event.sender, contextId)
  return null
})

handleMessage('ELECTRON_BROWSER_GUEST_WEB_CONTENTS', function (event, contextId, guestInstanceId) {
  let guestViewManager = require('./guest-view-manager')
  return valueToMeta(event.sender, contextId, guestViewManager.getGuest(guestInstanceId))
})

handleMessage('ELECTRON_BROWSER_ASYNC_CALL_TO_GUEST_VIEW', function (event, contextId, requestId, guestInstanceId, method, ...args) {
  let guestViewManager = require('./guest-view-manager')
...
handleMessage('ELECTRON_BROWSER_SEND_TO', function (event, sendToAll, webContentsId, channel, ...args) {
...
handleMessage('ELECTRON_BROWSER_WINDOW_CLOSE', function (event) {
...
handleMessage('ELECTRON_BROWSER_SANDBOX_LOAD', function (event) {
